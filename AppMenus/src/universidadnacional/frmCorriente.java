...
public class frmCorriente extends javax.swing.JInternalFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtCorriente, javax.swing.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE))))
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        double corriente, voltaje, resistemcia;
        voltaje = Double.parseDouble(txtVoltaje.getText());
        resistemcia = Double.parseDouble(txtResistencia.getText());
        corriente = Corriente.calcularCorriente(voltaje, resistemcia);
